...
//  MPI_Type_create_subarray(2, gsizes, lsizes, starts, ___________, __________, &vertical_border);
//  MPI_Type_commit(&vertical_border);
//  gsizes[0]=______; gsizes[1]=______; 
//  lsizes[0]=______; lsizes[1]=______;  starts[0]=_; starts[1]=_;
//  MPI_Type_create_subarray(2, gsizes, lsizes, starts, ___________, __________, &horizontal_border);
//  MPI_Type_commit(&horizontal_border);
