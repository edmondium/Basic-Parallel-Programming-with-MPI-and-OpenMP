...
! send and receive to/from left/right
 ...
 &                     right,MPI_ANY_TAG,comm, req(2),ierror)
  ...
  if (prt) then
    do ic = 0, idim-1 
      do kc = 0, kdim-1
        ...
        call MPI_BARRIER(comm,ierror) ! ito separate the printing of each block by different processes.
